      ...
      <div className="d-flex flex-column align-items-center justify-content-center flex-grow-1">
        <div className="info-box d-flex flex-column p-4">
          <div className="d-flex justify-content-start align-items-center">
            <h2 className="fw-bold" style={{ minWidth: "280px", textAlign: "left" }}>Movie:</h2>
            <h2 className="justify-content-start">Comedy Night</h2>
          </div>
          <div className="d-flex justify-content-start align-items-center">
            <h2 className="fw-bold" style={{ minWidth: "280px", textAlign: "left" }}>Showtime:</h2>
            <h2 className="justify-content-start">Feb 12, 8:00 pm</h2>
          </div>
          <div className="d-flex justify-content-start align-items-center">
            <h2 className="fw-bold" style={{ minWidth: "280px", textAlign: "left" }}>Seat:</h2>
            <h2 className="justify-content-start">D5</h2>
          </div>
          <div className="d-flex justify-content-start align-items-center">
            <h2 className="fw-bold" style={{ minWidth: "280px", textAlign: "left" }}>Refund Amount:</h2>
